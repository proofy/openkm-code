...
public class OKMDocument implements DocumentModule {
	...
	@Override
	public Document getProperties(String token, String docPath) throws RepositoryException, AccessDeniedException,
	...
	@Override
	public boolean isCheckedOut(String token, String docPath) throws AccessDeniedException, PathNotFoundException,
			RepositoryException, DatabaseException {
	...
	@Override
	public List<Version> getVersionHistory(String token, String docPath) throws AccessDeniedException, PathNotFoundException,
			RepositoryException, DatabaseException {
	...
	@Override
	public boolean isLocked(String token, String docPath) throws AccessDeniedException, PathNotFoundException,
			RepositoryException, DatabaseException {
	...
	@Override
	public LockInfo getLockInfo(String token, String docPath) throws LockException, AccessDeniedException, PathNotFoundException,
			RepositoryException, DatabaseException {
	...
	@Override
	public long getVersionHistorySize(String token, String docPath) throws AccessDeniedException, PathNotFoundException,
			RepositoryException, DatabaseException {
