...
public class GWTUtil {
	 ...
	 */
	public static GWTReport copy(Report report, List<FormElement> formElements) throws AccessDeniedException,
			PathNotFoundException, RepositoryException, DatabaseException, PrincipalAdapterException, IOException,
