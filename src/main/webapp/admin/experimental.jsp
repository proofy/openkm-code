  ...
  <c:choose>
    <c:when test="${isAdmin}">
      ...
      <center>
        ...
        <a href="benchmark.jsp"><button class="utilButton">Benchmark</button></a>
        <a href="populate.jsp"><button class="utilButton">Populate</button></a>
        <a href="repository_backup.jsp"><button class="utilButton">Repository backup</button></a>
        <a href="repository_restore.jsp"><button class="utilButton">Repository restore</button></a>
        <a href="installation_reset.jsp"><button class="utilButton">Installation reset</button></a>
