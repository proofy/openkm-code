   ...
   <c:choose>
    <c:when test="${isAdmin}">
      ...
      <table class="results" width="75%">
        <tr>
          <td></td><th>Param 1</th><th>Param 2</th><th>Param 3</th><th>Param 4</th>
        </tr>
        <tr class="even">
          <th>OpenKM import</th><td>Filesystem path</td><td>Number of import cycles</td><td>X</td><td>X</td>
        </tr>
        <tr class="odd">
          <th>OpenKM copy</th><td>Source folder</td><td>Destination folder</td><td>Number of copy cycles</td><td>X</td>
        </tr>
        <tr class="even">
          <th>OpenKM generate</th><td>Max number of documents</td><td>Max number of folders</td><td>Max depth</td><td>Max iterations</td>
        </tr>
      </table>
    </c:when>
    <c:otherwise>
